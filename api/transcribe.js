      ...
      : isSocial
        ...
        : isKorean
          ...
          : isHistory
            ...
            : isScience
              ? (isGuardedSuneungScienceCourse(courseId)
                ? "수능 과학탐구 학생이 선생님과 대화합니다. 학생은 답을 말하거나, 개념의 뜻을 질문하거나, 설명·힌트·예시를 요청하고 앞선 설명에 이어 질문할 수 있습니다. 질문과 문장을 끝까지 그대로 받아쓰세요. A(에이), B(비), C(씨), D(디), E(알파벳 이) 및 1번부터 5번 답안도 들린 그대로 적으세요. 질문을 답안으로 줄이지 마세요. 정답을 추측하거나 답을 바꾸지 마세요."
