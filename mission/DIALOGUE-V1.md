...
Deployment uses an explicit /api/mission-chat rewrite to the legacy builder's /api/mission-chat.js function. Sequential typing before lesson start retains focus; continuing from a draft initializes the lesson and avatar. The cache version is advanced for existing preview visitors.
