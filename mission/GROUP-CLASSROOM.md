...
A class of 20–30 learners shares one screen. The avatar explains before the teacher advances to a question. Learners discuss; the teacher types or dictates one representative response, then explicitly advances through activity and summary. There are no individual scores, attempt counters, quiz hints or materials-library controls. Automatic advancement is disabled in group mode.
