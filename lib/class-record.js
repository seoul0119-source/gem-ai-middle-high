...
export function recordFromRequest(student,body){
 ...
 const record={id:p.id,student:p.student,course:p.course,started:p.started,revision:r.revision,status:r.status,messages,counters:recordProgress(messages,counters),lease:p.lease||""};
