...
const pages = new Set(["class", "learn", "learn-fr", "english", "suneung", "international-en", "international-fr", "emma-test", "materials"]);
...
export async function serveStudentPage(request, response) {
  ...
  if (!readStudentSession(request)) {
    response.setHeader("Location", page === "materials" ? "/?materials=1" : "/");
